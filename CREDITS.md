...
- **images/stop-6-2.jpg** — The family's own photo (relaxing on a pool float at the Port of Call — Day 6 adult time in the pool; same photo as stop-3-4).
...
- **images/stop-7-2.jpg** — DZ6 2628 Cozy candlelit dinner for two elegant Thai restaurant setting with twinkling lights and a delicate orchid centerpiece.jpg · CC BY-SA 4.0 · [PattayaPatrol](https://commons.wikimedia.org/wiki/File:DZ6_2628_Cozy_candlelit_dinner_for_two_elegant_Thai_restaurant_setting_with_twinkling_lights_and_a_delicate_orchid_centerpiece.jpg) _(murder mystery dinner — moved here from Day 6)_
